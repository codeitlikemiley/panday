...
//! `ferrum_sdk::providers::openai_compat` — docs/10: "the same stack runs
...
use ferrum_sdk::providers::openai_compat::OpenAiCompatClient;
use ferrum_sdk::{FerrumError, ItemStream, ModelClient};
